	...
	<div class="content-body">
		<div class="container vh-100">
			<div class="welcome-area">
				...
				<div class="join-area">
					<div class="started">
						<h5 style="color: white;">Selamat datang,</h5>
						<!-- <p>Penamas adalah layanan pengaduan untuk masyarakat dari Jasa Raharja</p> -->
						<p>Silahkan pilih kategori dibawah ini untuk melanjutkan</p>
					</div>
