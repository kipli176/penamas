    ...
    <div class="page-content bottom-content">
        ...
        <?php if (isset($errors) && !empty($errors)) {?>                
            ...
            <?php echo form_open('kecelakaan/add', ['enctype' => 'multipart/form-data']); ?>
                ...
                <label for="inputAddress" class="border-bottom w-100 pb-1 mb-3">Google Map - <i class="text-xs">Diperuntukkan, apabila masyarakat/korban mengetahui Lokasi Kecelakaan (Tempat Kejadian Perkara)</i></label>
...
<script>
	...
	$(document).ready(function() { 
        ...
        placeholder: "Pilih Tempat/Rumah Sakit",
        allowClear: true
        });
        $('#jenis').select2({
