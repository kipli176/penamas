            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Laporan Kecelakaan</a></li>
					</ol>
                </div>
                <!-- row -->
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Data Laporan Kecelakaan</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="examples" class="display table-responsive-lg">
                                        <thead>
                                            <tr>
                                                <th>Nomor</th> 
                                                <th>Whatsapp</th> 
