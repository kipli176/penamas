       ...
       <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li class="has-menu mm-active"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-notepad"></i>
            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Kantor</a></li>
					</ol>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="javascript:void(0);" class="btn btn-primary btn-rounded" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter"><i class="las la-plus scale5 me-3"></i>Tambah</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr> 
                                                ...
                                                <div class="d-flex">
														...
														<a href="/admin/kantor/hapus/<?php echo $item->_id; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i> </a>
													</div>
													<!-- <div class="dropdown ms-auto text-end">
														...
														<div class="dropdown-menu dropdown-menu-end"> 
															<a class="dropdown-item" href="/admin/aspirasi/detail/<?php echo $item->_id; ?>">Ubah</a>
															<a class="dropdown-item" href="/admin/aspirasi/hapus/<?php echo $item->_id; ?>">Hapus</a> 
														</div>
													</div> -->
												</td>
                                            </tr>
                                    ...
                                    <div class="modal fade" id="exampleModalCenter">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <form action="/admin/kantor/add" method="post">
                                                ...
                                                <div class="modal-body">
                                                    <div class="input-group mb-3 input-warning-o">
                                                        <span class="input-group-text">Nama Kantor</span>
                                                        <input type="text" class="form-control" placeholder="SAMSAT" name="kantor" style="text-transform: uppercase">
                                                    </div>                                        
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</button>
                                                    <button type="submit" class="btn btn-info light">Tambah</button>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
