...
<head>
    ...
    <link href="/admine/vendor/lightgallery/css/lightgallery.min.css" rel="stylesheet">
...
<body style="background: var(--headerbg);!mportant">
    ...
    ***********************************-->
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="has-menu mm-active"><a class="has-arrow ai-icon" href="javascript:void()"
                            aria-expanded="false">
                            ...
                            <div class="read-content">
                                <div class="media pt-3 d-sm-flex d-block justify-content-between">
                                    <div class="clearfix mb-3 d-flex">
                                        ...
                                        <div class="media-body me-2">
                                            <h5 class="text-primary mb-0 mt-1"><?php echo $detail->nama; ?></h5>
                                            <p class="mb-0"><?php echo date('d M Y', $detail->tgl); ?></p>
                                            <p class="read-content-email"><?php echo $detail->wa; ?></p>
                                        </div>
                                    </div>
                                    <div class="clearfix mb-3">
                                        <a href="javascript:history.back()"
                                            class="btn btn-primary px-3 my-1 light me-2"><i class="fa fa-reply"></i>
                                        </a>
                                        <!-- <a href="javascript:void()" class="btn btn-primary px-3 my-1 light me-2"><i class="fa fa-arrow-right"></i> </a> -->
                                        <a class="btn btn-primary px-3 my-1 light me-2" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter"><i class="fa fa-trash"></i></a>
                                    </div>
                                    <!-- Modal -->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Anda yakin makan menghapus data dari <?php echo $detail->nama; ?>?</p>
                                                </div>
                                ...
                                <div class="media mb-2 mt-3">
                                    <div class="media-body">
                                        ...
                                        <h3 class="my-1 text-primary"><?php echo $detail->judul; ?></h3>

                                    </div>
                                </div>
                                <div class="read-content-body">
                                    <h5 class="mb-4">Halo Jasa Raharja,</h5>
                                    <p class="mb-2"><?php echo $detail->isi; ?></p>
                                    <h5 class="pt-3">Salam</h5>
                                    <p><?php echo $detail->nama; ?></p>
                                    <hr>
                                </div>
                                <?php if ($judul == 'Detail Aduan') {?>
    ...
    <script src="/admine/vendor/lightgallery/js/lightgallery-all.min.js"></script>
