...
<body style="background: var(--headerbg);!mportant">
    ...
    ***********************************-->
            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Layanan Aspirasi</a></li>
					</ol>
                </div>
                <!-- row -->
                                        ...
                                        <tbody>
                                            ...
                                            <tr> 
                                                ...
                                                <div class="d-flex">
														...
														<a href="/admin/user/hapus/<?php echo $item->_id; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i> </a>
													</div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
													...
													<div class="mb-3 row">
														...
														<div class="col-sm-9">
															<select id="single-select" name="kantor">
																<option></option>
    ...
    <script src="/admine/js/plugins-init/select2-init.js"></script>
	<script>
