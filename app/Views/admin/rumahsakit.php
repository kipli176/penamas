            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Rumah Sakit</a></li>
					</ol>
                </div>
                <!-- row -->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <div class="d-flex">
														...
														<a href="/admin/rumahsakit/hapus/<?php echo $item->_id; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i> </a>
													</div>
													<!-- <div class="dropdown ms-auto text-end">
														...
														<div class="dropdown-menu dropdown-menu-end"> 
															<a class="dropdown-item" href="/admin/aspirasi/detail/<?=$item->_id;?>">Ubah</a>
															<a class="dropdown-item" href="/admin/aspirasi/hapus/<?=$item->_id;?>">Hapus</a> 
														</div>
													</div> -->
												</td>
                                            </tr>
                ...
                <p>PENA MAS  © 2023 v1.2</p>
                                    ...
                                    <div class="modal fade" id="exampleModalCenter">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                    		...
                                    		<form action="/admin/rumahsakit/add" method="post">
												...
												<div class="input-group mb-3 input-warning-o">
													<span class="input-group-text">Nama RS</span>
													<input type="text" class="form-control" placeholder="RS" name="rs" style="text-transform: uppercase">
												</div>
